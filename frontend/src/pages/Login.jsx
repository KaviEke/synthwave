...
function Login() {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        {/* Left Branding Pane */}
        <div style={{ flex: '1 1 350px', background: 'transparent', borderRight: '1px solid var(--primary)', padding: '4rem 3rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: 'white', textAlign: 'center' }}>
